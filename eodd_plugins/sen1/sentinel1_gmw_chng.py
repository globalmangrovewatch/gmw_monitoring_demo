                        ...
                        for scr_tile in score_tiles:
                            ...
                            if n_chng_pxls > 0:
                                ...
                                for base_chng_year in self.params["base_chngs"]:
                                    ...
                                    date_delta = scn_db_obj.Acquisition_Date - base_chng_date
                                ...
                                if n_chng_pxls > 0:
                                    ...
                                    rsgislib.vectorutils.rasteriseVecLyr(valid_wgs84_vec_file, 'vld', scr_tile, gmw_tile_vld_img, gdalformat="KEA", burnVal=1)
                                    rsgislib.rastergis.populateStats(gmw_tile_vld_img, addclrtab=True, calcpyramids=True, ignorezero=True)
                                    vld_feat_pxl_counts = rsgislib.rastergis.ratutils.getColumnData(gmw_tile_vld_img, 'Histogram')
                                    ...
                                    if (n_vld_pxls > 0):
                                        ...
                                        out_scn_dir = os.path.join(self.params['out_data_path'], "{}_{}_scn_chng_tiles".format(scn_db_obj.Product_File_ID, scn_db_obj.PID))
                                        ...
                                        exp = '(chng==1)&&(score>=4)&&(score<5)?1:0'  # sar data change is a score of 1 (Optical 2)
                                        ...
                                        update_uid_image(uid_tile, gmw_tile_chng_img, gmw_tile_reached_5scr_img, gmw_tile_vld_img, year_obs, day_year_obs, lcl_tile_uid_img)

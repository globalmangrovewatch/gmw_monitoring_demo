...
def update_uid_image(uid_img, chng_img, nxt_scr5_img, clrsky_img, obs_day_since_base, tmp_uid_tile):
    ...
    def _update_uid_img(info, inputs, outputs, otherargs):
        ...
        uid_img_arr[1, new_chng_pxls==1] = obs_day_since_base
        uid_img_arr[2, inputs.clrsky_img[0]==1] = 1970
        uid_img_arr[3, inputs.clrsky_img[0]==1] = obs_day_since_base
        uid_img_arr[4, new_scr5_pxls==1] = 1970
        uid_img_arr[5, new_scr5_pxls==1] = obs_day_since_base

...
class GenCmdsGenBinChngMsks(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(scn_wgs84_img_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_scn_bin_chng_wgs84_tiles_2020',
                              ref_tiles_path='/scratch/a.pfb/gmw_monitoring/monitoring/scores_imgs',
                              out_tile_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_bin_chng_wgs84_tiles_2020',
                              out_vec_tile_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_bin_chng_wgs84_tiles_vec_2020')
        self.pop_params_db()

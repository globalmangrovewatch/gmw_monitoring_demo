...
class GenCmdsGenBinChngMsks(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for tile in tqdm.tqdm(tiles):
            ...
            if len(tiles_to_merge) > 0:
                ...
                c_dict["out_vec_file"] = os.path.join(kwargs['out_vec_tile_path'], "{}_chng_bin_msk.gpkg".format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(scn_wgs84_img_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_scn_bin_chng_wgs84_tiles_2019',
                              ref_tiles_path='/scratch/a.pfb/gmw_monitoring/monitoring/scores_imgs',
                              out_tile_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_bin_chng_wgs84_tiles_2019',
                              out_vec_tile_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_bin_chng_wgs84_tiles_vec_2019')
        self.pop_params_db()

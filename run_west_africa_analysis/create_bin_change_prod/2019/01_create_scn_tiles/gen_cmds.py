...
class GenCmdsGenBinChngMsks(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(config_file='/scratch/a.pfb/gmw_monitoring/scripts/eodd_config_west_africa/EODataDownConfig_psql.json',
                              ...
                              scn_ls_chng_vecs_path='/scratch/a.pfb/gmw_monitoring/data/west_africa/landsat/scn_chng_vecs',
                              scn_s2_chng_vecs_path='/scratch/a.pfb/gmw_monitoring/data/west_africa/sen2/scn_chng_vecs',
                              img_lut='/scratch/a.pfb/gmw_monitoring/monitoring/gmw_monitor_lut.gpkg',
                              scr_lut_lyr='score_imgs',
                              scn_out_wgs84_img_path='/scratch/a.pfb/gmw_monitoring/data_out/gmw_scn_bin_chng_wgs84_tiles_2019',
                              tmp_dir='/scratch/a.pfb/gmw_monitoring/tmp_dir')
        self.pop_params_db()
        self.create_slurm_sub_sh("gen_bin_msk_wa_2019", 18504, '/scratch/a.pfb/gmw_monitoring/logs',

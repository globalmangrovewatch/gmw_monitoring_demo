...
class CreateEODataDownCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(config_file='/scratch/a.pfb/gmw_monitoring/scripts/eodd_config_west_africa/EODataDownConfig_psql.json', sensors=['Sentinel2GOOG'])#LandsatGOOG
        self.pop_params_db()
